...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"**`! ●̲̅̅ 𝗔𝗙𝗞 ●̲̅̅\n Sedang Sibuk, Tunggu {ALIVE_NAME} Aktif Kembali`**",
    f"**`! ●̲̅̅ 𝗔𝗙𝗞 ●̲̅̅\n Mohon Maaf {ALIVE_NAME} Sedang Sibuk\n Sedang Mengocok dan mengomek!!**",
    f"**`! ●̲̅̅ 𝗔𝗙𝗞 ●̲̅̅\n {ALIVE_NAME} Sedang Cari cuan\n Tunggu {ALIVE_NAME} Online Kembali !!!!!`**",
    f"**`! ●̲̅̅ 𝗔𝗙𝗞 ●̲̅̅\n Maaf {ALIVE_NAME} Sedang Rapat!!`**",
]
...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(f"**!𖠁𝗔𝗙𝗞𖠁**\n╬╬═══════════╬╬\n{ALIVE_NAME} MAAF SEDANG OFF...\
        \n𝗥𝗘𝗔𝗦𝗢𝗡: `{string}`\n╬╬═══════════╬╬")
    else:
        await afk_e.edit(f"**! 𖠁𝗔𝗙𝗞𖠁**\n╬╬═══════════╬╬\n{ALIVE_NAME} NANTI SAYA BACA, JANGAN DIHAPUS...\n╬╬═══════════╬╬")
    if user.last_name:
    ...
    if mention.message.mentioned and not (await mention.get_sender()).bot:
        if ISAFK:
            ...
            if mention.sender_id not in USERS:
                if AFKREASON:
                    await mention.reply(f"**! 𖠁𝗔𝗙𝗞𖠁**\n╬╬═══════════╬╬\n{ALIVE_NAME} Tidak Aktif **\nLama 𝗔𝗙𝗞 : {afk_since}.\
                        \n𝗥𝗘𝗔𝗦𝗢𝗡: `{AFKREASON}`\n╬╬═══════════╬╬")
                else:
